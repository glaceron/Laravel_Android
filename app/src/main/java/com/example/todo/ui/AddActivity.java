...
public class AddActivity extends AppCompatActivity implements View.OnClickListener, Callback<AddResponse> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.numberPickerDia.setOnClickListener(this);
    ...
    private void connection(Reserva reserva) {
        ...
        Call<AddResponse> call = ApiTokenRestClient.getInstance(preferences.getToken()).createReserva(reserva);
        call.enqueue(this);
    }
    ...
    public void onResponse(Call<AddResponse> call, Response<AddResponse> response) {
        ...
        if (response.isSuccessful()) {
            ...
            if (addResponse.getSuccess()) {
                ...
                bundle.putInt("user", addResponse.getData().getUser());
                ...
                setResult(OK, i);
                finish();
                showMessage("Reserva created ok");
            } else {
